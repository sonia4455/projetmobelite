...
evaluationRouter.route('/grammar/notes').get(evaluationController.getDiagnosticResultAnalysisAdditional);
evaluationRouter.route('/grammar/notes').post(evaluationController.setDiagnosticResultAnalysisAdditional);
// need to be changed
